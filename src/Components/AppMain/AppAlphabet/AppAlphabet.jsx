...
const AppAlphabet = () => {
    ...
    return (
        <section className="App_alphabet">
            ...
            <div className="App_alphabet-values App_alphabet-values--first">{MorseAlphabetLetters.map(letter => <p key={letter}><strong>{`${letter}:`}</strong></p>)}</div>
            <div className="App_alphabet-values App_alphabet-values--second">{MorseAlphabetNumbers.map(number => <p key={number}><strong>{`${number}:`}</strong></p>)}</div>
            <div className="App_alphabet-values">{MorseAlphabetSymbols.map(symbol => <p key={symbol}><strong>{`${symbol}:`}</strong></p>)}</div>
